...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('vm_runtime_states')) {
        ...
        if (Schema::hasTable('development_requests') && ! Schema::hasColumn('development_requests', 'execution_target_key')) {
        ...
        if (! Schema::hasTable('vm_lifecycle_actions')) {
