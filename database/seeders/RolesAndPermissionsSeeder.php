...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissionFamilies = [
            ...
            'development_requests' => ['view', 'view_any', 'create', 'update', 'delete', 'approve', 'prioritize', 'cancel'],
        ...
        $rolesDefinition = [
            ...
            Role::ROLE_CUSTOMER_ADMIN => [
                ...
                'permissions' => [
                    ...
                    'development_requests.prioritize', 'development_requests.cancel', 'testing.view', 'testing.approve', 'meetings.view',
            ...
            Role::ROLE_PRODUCT_OWNER => [
                ...
                'permissions' => [
                    ...
                    'development_requests.approve', 'development_requests.prioritize', 'development_requests.cancel', 'agent_runs.view',
            ...
            Role::ROLE_ENGINEER => [
                ...
                'permissions' => [
                    ...
                    'development_requests.cancel', 'agent_runs.view', 'agent_runs.view_any', 'agent_runs.execute', 'pull_requests.view',
