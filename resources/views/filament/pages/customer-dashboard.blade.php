<x-filament-panels::page class="relative">
    {{-- Glassmorphism Full Dashboard Loading Overlay --}}
    <div wire:loading.flex class="fixed inset-0 z-50 bg-gray-900/60 backdrop-blur-md flex flex-col items-center justify-center transition-opacity duration-300">
        <div class="p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl flex flex-col items-center gap-4 max-w-sm w-full mx-4 text-center">
            ...
            <div>
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Switching Customer Account...</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Fetching live action items, KPI metrics, and meeting schedules.</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 mb-4 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">Select a customer account to inspect action items, active pipeline, and account usage.</p>
            </div>
        </div>
    ...
    {{-- 2. Top KPI Cards --}}
    <div class="mb-6">
        @livewire(\App\Filament\Widgets\Customer\CustomerKpiWidget::class)
    </div>

    {{-- 3. Page Subheader --}}
    <div class="mb-4">
        <p class="text-sm text-gray-500 dark:text-gray-400">
            Welcome to your central Technopath Forge dashboard. Monitor action items, track delivery progress, review estimate sign-offs, and inspect account usage.
        </p>
    </div>

    {{-- Widgets will automatically render via getHeaderWidgets and getFooterWidgets --}}
