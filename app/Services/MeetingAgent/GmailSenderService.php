...
/**
 * Gmail Sender Service — Direct email sending.
 *
 * This is a specialized class for direct email sending on behalf of the user,
 * keeping GmailService pure to comply with the safety draft-only constraints.
 */
class GmailSenderService
{
    ...
    /**
     * Send an email immediately on behalf of the connected user.
     * Returns the Gmail message ID.
     *
     * @throws RuntimeException if user lacks gmail.compose scope
     */
    public function sendEmail(string $to, string $subject, string $body, array $cc = []): string
    {
    ...
    private function handleGoogleApiError(\Google\Service\Exception $e): void
    {
        ...
        Log::error('GmailSenderService: Google API error', [
